CREATE OR REPLACE FUNCTION "public"."notable_retraps" (
...
ALTER FUNCTION "public"."notable_retraps" (
	"result_limit" integer,
	"result_limit_per_species" integer,
	"min_proven_age" integer,
	"min_encounter_count" integer,
	"species_filter" "text",
	"year_filter" integer,
