...
DROP FUNCTION public.stats_per_day_and_species(IN ringing_group_filter bigint);
...
END;
$function$;
CREATE FUNCTION public.stats_per_day_and_species(ringing_group_filter bigint)
 RETURNS TABLE(species_name text, visit_date date, encounter_count bigint, juv_count bigint, postjuv_count bigint, pullus_count bigint, weighed_birds_count bigint, min_weight numeric, max_weight numeric)
 LANGUAGE plpgsql
 STABLE
