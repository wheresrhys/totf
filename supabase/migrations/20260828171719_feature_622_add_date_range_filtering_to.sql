...
DROP FUNCTION public.notable_retraps(IN result_limit integer, IN result_limit_per_species integer, IN min_proven_age integer, IN min_encounter_count integer, IN species_filter text, IN year_filter integer, IN ringing_group_filter bigint);
CREATE FUNCTION public.notable_retraps(result_limit integer DEFAULT NULL::integer, result_limit_per_species integer DEFAULT NULL::integer, min_proven_age integer DEFAULT NULL::integer, min_encounter_count integer DEFAULT NULL::integer, species_filter text DEFAULT NULL::text, from_date date DEFAULT NULL::date, to_date date DEFAULT NULL::date, ringing_group_filter bigint DEFAULT NULL::bigint)
...
END;
$function$;
GRANT ALL ON FUNCTION public.notable_retraps(integer, integer, integer, integer, text, date, date, bigint) TO anon;
GRANT ALL ON FUNCTION public.notable_retraps(integer, integer, integer, integer, text, date, date, bigint) TO authenticated;
GRANT ALL ON FUNCTION public.notable_retraps(integer, integer, integer, integer, text, date, date, bigint) TO service_role;
