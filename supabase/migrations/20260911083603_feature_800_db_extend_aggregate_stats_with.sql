...
ALTER TYPE public.aggregate_stats_result DROP ATTRIBUTE first_summer_bird_count;
ALTER TYPE public.aggregate_stats_result DROP ATTRIBUTE new_adult_bird_count;
ALTER TYPE public.aggregate_stats_result DROP ATTRIBUTE new_postjuv_enc_count;
ALTER TYPE public.aggregate_stats_result DROP ATTRIBUTE new_postjuv_juv_enc_count;
ALTER TYPE public.aggregate_stats_result DROP ATTRIBUTE oldies_bird_count;
ALTER TYPE public.aggregate_stats_result DROP ATTRIBUTE postjuv_juv_enc_count;
CREATE TYPE public.population_stats_result AS (species_name text, time_period date, adult_bird_count bigint, juv_bird_count bigint, juv_enc_count bigint, postjuv_enc_count bigint, new_young_bird_count bigint, new_adult_bird_count bigint, first_summer_bird_count bigint, oldies_bird_count bigint, postjuv_juv_enc_count bigint, new_postjuv_juv_enc_count bigint, new_postjuv_enc_count bigint);
CREATE FUNCTION public.agg_bird_age_bucket(species_name_filter text DEFAULT NULL::text, from_date date DEFAULT NULL::date, to_date date DEFAULT NULL::date, ringing_group_filter bigint DEFAULT NULL::bigint, group_by_species boolean DEFAULT false, group_by_time_period text DEFAULT NULL::text)
...
AS $function$
  WITH encounter_age_classification AS (
    SELECT * FROM public.agg_encounter_age_classification(species_name_filter, from_date, to_date, ringing_group_filter, group_by_species, group_by_time_period)
  ), bird_age_flags AS (
    SELECT
      eac.bird_id,
      eac.species_id,
...
$function$;
GRANT ALL ON FUNCTION public.agg_bird_age_bucket(text, date, date, bigint, boolean, text) TO anon;
GRANT ALL ON FUNCTION public.agg_bird_age_bucket(text, date, date, bigint, boolean, text) TO authenticated;
GRANT ALL ON FUNCTION public.agg_bird_age_bucket(text, date, date, bigint, boolean, text) TO service_role;
CREATE FUNCTION public.agg_encounter_age_classification(species_name_filter text DEFAULT NULL::text, from_date date DEFAULT NULL::date, to_date date DEFAULT NULL::date, ringing_group_filter bigint DEFAULT NULL::bigint, group_by_species boolean DEFAULT false, group_by_time_period text DEFAULT NULL::text)
...
AS $function$
  WITH raw_encounters AS (
    SELECT * FROM public.agg_raw_encounters(species_name_filter, from_date, to_date, ringing_group_filter)
  )
  SELECT
    re.encounter_id,
    re.bird_id,
...
$function$;
GRANT ALL ON FUNCTION public.agg_encounter_age_classification(text, date, date, bigint, boolean, text) TO anon;
GRANT ALL ON FUNCTION public.agg_encounter_age_classification(text, date, date, bigint, boolean, text) TO authenticated;
GRANT ALL ON FUNCTION public.agg_encounter_age_classification(text, date, date, bigint, boolean, text) TO service_role;
CREATE FUNCTION public.agg_raw_encounters(species_name_filter text DEFAULT NULL::text, from_date date DEFAULT NULL::date, to_date date DEFAULT NULL::date, ringing_group_filter bigint DEFAULT NULL::bigint)
...
$function$;
GRANT ALL ON FUNCTION public.agg_raw_encounters(text, date, date, bigint) TO anon;
GRANT ALL ON FUNCTION public.agg_raw_encounters(text, date, date, bigint) TO authenticated;
GRANT ALL ON FUNCTION public.agg_raw_encounters(text, date, date, bigint) TO service_role;
CREATE FUNCTION public.agg_spine(species_name_filter text DEFAULT NULL::text, from_date date DEFAULT NULL::date, to_date date DEFAULT NULL::date, ringing_group_filter bigint DEFAULT NULL::bigint, group_by_species boolean DEFAULT false, group_by_time_period text DEFAULT NULL::text)
...
$function$;
GRANT ALL ON FUNCTION public.agg_spine(text, date, date, bigint, boolean, text) TO anon;
GRANT ALL ON FUNCTION public.agg_spine(text, date, date, bigint, boolean, text) TO authenticated;
GRANT ALL ON FUNCTION public.agg_spine(text, date, date, bigint, boolean, text) TO service_role;
...
END;
$function$;
CREATE FUNCTION public.population_stats(species_name_filter text DEFAULT NULL::text, from_date date DEFAULT NULL::date, to_date date DEFAULT NULL::date, ringing_group_filter bigint DEFAULT NULL::bigint, group_by_species boolean DEFAULT false, group_by_time_period text DEFAULT NULL::text)
...
AS $function$
  ...
  FROM (
  WITH spine AS (
    SELECT * FROM public.agg_spine(species_name_filter, from_date, to_date, ringing_group_filter, group_by_species, group_by_time_period)
  ), encounter_age_classification AS (
    SELECT * FROM public.agg_encounter_age_classification(species_name_filter, from_date, to_date, ringing_group_filter, group_by_species, group_by_time_period)
  ), bird_age_bucket AS (
    SELECT * FROM public.agg_bird_age_bucket(species_name_filter, from_date, to_date, ringing_group_filter, group_by_species, group_by_time_period)
  ),
  ...
  -- can't answer. Group scoping mirrors agg_raw_encounters' pattern so a bird's
