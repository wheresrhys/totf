...
ALTER TYPE public.population_stats_result ADD ATTRIBUTE old_timers_bird_count bigint;
ALTER TYPE public.population_stats_result DROP ATTRIBUTE oldies_bird_count;
