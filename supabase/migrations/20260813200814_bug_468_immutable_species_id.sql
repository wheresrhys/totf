...
CREATE FUNCTION public.trg_prevent_bird_species_id_change()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE TRIGGER trigger_trg_prevent_bird_species_id_change BEFORE UPDATE ON public."Birds" FOR EACH ROW EXECUTE FUNCTION public.trg_prevent_bird_species_id_change();
