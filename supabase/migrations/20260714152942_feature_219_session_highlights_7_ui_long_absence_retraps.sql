...
DROP FUNCTION public.session_long_absence_retraps(IN session_date date, IN ringing_group_filter bigint, IN min_gap_days integer);
CREATE FUNCTION public.long_absence_retraps(session_date date, ringing_group_filter bigint, min_gap_days integer DEFAULT 730)
 RETURNS TABLE(ring_no text, species_name text, previous_date date, gap_days integer)
 LANGUAGE plpgsql
 STABLE
