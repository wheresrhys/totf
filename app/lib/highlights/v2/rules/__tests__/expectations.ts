export const expectations = {
	...
	species: {
		...
		'this year': 'Most varied session this year: 12 birds',
		'tied second of month':
	...
	singleSpeciesEncounters: {
		...
		'tied second global':
			'Equal second most encounters of a single species in a session ever: 12 birds',
		'tied second of year':
			'Equal second most encounters of a single species in a session in 2020: 12 birds',
		'this year':
			'Most encounters of a single species in a session this year: 12 birds',
		'tied second of month':
			'Equal second most encounters of a single species in a session in any February: 12 birds',
		'tied global and second of year':
			'Equal most encounters of a single species in a session ever and second most of 2020: 12 birds',
		'global and tied second of year and third of month':
			'Most encounters of a single species in a session ever, equal second most of 2020 and third most in any February: 12 birds'
	},
	eachSpeciesCount: {
