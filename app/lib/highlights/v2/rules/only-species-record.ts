...
// on its first-ever and first-of-year highlights; here it is its own metric,
// since a HighlightValue carries a number and a period and has nowhere to put a
// boolean.
//
...
// of that year prints both lines ("First Robin ever" and "Only Robin of 2024").
