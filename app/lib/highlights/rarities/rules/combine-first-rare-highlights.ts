...
export function combineFirstRareHighlights(
	highlights: RarityHighlight[]
): RarityHighlight[] {
	const megaByBase = new Map<RarityHighlight, MegaSpeciesHighlight>();
	const consumedRareHighlights = new Set<RarityHighlight>();
