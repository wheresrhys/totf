...
// deduped by a narrower-scope removal rule; all scope reconciliation for weights
// happens here.
export function combineWeightRecords(
	highlights: VitalStatHighlight[]
): VitalStatHighlight[] {
	...
	const removed = new Set<VitalStatHighlight>();
	...
	const result: VitalStatHighlight[] = [];
